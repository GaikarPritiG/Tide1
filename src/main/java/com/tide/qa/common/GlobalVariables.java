...
public class GlobalVariables {
	...
	private static String VSTSFlag=null;
	...
	//Get Visual Studio Test System Auto Build Flag
	public String getVSTSFlag(){
		return VSTSFlag;
	}

	//Set Visual Studio Team System Auto Build flag to indicate the tests are executing in auto build.
	public void setVSTSFlag(String VSTS){
